...
- (fixed) Fixed bug not allowing use of custom classes on model management action links
- (fixed) Fixed error generated by WP when using the RestRoute annotation
